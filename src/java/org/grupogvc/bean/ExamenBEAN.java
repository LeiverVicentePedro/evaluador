...
public class ExamenBEAN implements Serializable {
    ...
    public void evaluando() throws Exception {
        ...
        if (nombreBoton.equalsIgnoreCase("Finalizar")) {
            ...
            datoEvaluante =  new DatoEvaluanteDAO().buscaDato(categoria.getIdevaluacion().getIdCategoria(),personal.getIdpersonal());
            if(datoEvaluante.getIdevaluante()==null){
                datoEvaluante.setIdevaluante(personal);
                datoEvaluante.setIntento(1);
                datoEvaluante.setNorma(categoria.getIdevaluacion());
                new DatoEvaluanteDAO().registrarDatoEvaluante(datoEvaluante);
            }else{
                datoEvaluante.setIntento(datoEvaluante.getIntento()+1);
                new DatoEvaluanteDAO().actualizarDatoEvaluante(datoEvaluante);
            }
    ...
    public void accionBoton() {
        ...
        } else if (preguntasActiva == categoria.getNum_preguntas() - 1) {//si es igual sera finalizar
